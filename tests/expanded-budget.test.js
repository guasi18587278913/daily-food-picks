...
const env={DFP_ENABLED:'true',DFP_FREE_AI_CONFIRMED:'true',DFP_TIMER_SECRET:'a'.repeat(64),DFP_DAILY_CALLS:'250',DFP_DAILY_MICRO_USD:'2500000',
...
test('expanded supplement spends at most fifty, preserves fifty for evening and counts prior extra research',async()=>{
 const {store,round,args}=await setup();assert.equal(round.reservedRegularCalls,50);
